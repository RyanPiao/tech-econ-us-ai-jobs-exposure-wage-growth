# Step 7 — Final Public Research Progress Summary
...
- Step 3 latest-year correlation (exposure vs cumulative growth): **0.4369**
- Step 4 baseline TWFE coefficient (`ai_exposure_x_post2022`): **-0.001273** (SE 0.002836)
- Step 5 robustness specs estimated: **4**
- Step 6 event-study window: **[-6, 3]**, reference -1
- Step 6 mean pre-event coefficient (k<=-2): **-0.000447**
